...
LabGenios Nano - Teste 03: Teste do Buzzer de tons

Jumper J4 deve estar fechado para que a saída digita D3 esteja conectada ao Buzzer


I/Os Digitais utilizados para o Buzzer funcionar:
D3 - Buzzer
*/

// ----------------------------------------------------------------------
// O projeto original foi desenvolvido por HiBit <https://www.hibit.dev>
// ----------------------------------------------------------------------

//Arquivo com definições dos valores de tons / frequências
#include "pitches.h"

//Define uma constante (ou "apelido") para o pino de IO D3
#define BUZZER_PIN 3
